...
export default function AcademicsCMS() {
  ...
  const [academicsData, setAcademicsData] = useState({
    ...
    pedagogySubtitle: "",
    phases: [
      { phase: "Phase 01", title: "", years: "", desc: "", color: "emerald" },
      { phase: "Phase 02", title: "", years: "", desc: "", color: "amber" },
      { phase: "Phase 03", title: "", years: "", desc: "", color: "indigo" },
      { phase: "Phase 04", title: "", years: "", desc: "", color: "rose" }
    ],
    infrastructureTitle: "",
    infrastructureDesc: ""
  });
          ...
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6">
            ...
            <div className="space-y-6">
              <div className="relative group cursor-pointer aspect-video rounded-3xl bg-slate-100 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center overflow-hidden transition-all hover:border-indigo-300">
                <img 
                  src="/images/redesign/academics_banner.png" 
