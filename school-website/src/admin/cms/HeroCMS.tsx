      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6">
            ...
            <div className="relative group cursor-pointer aspect-[4/3] rounded-3xl bg-slate-100 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center overflow-hidden transition-all hover:border-indigo-300">
              <img 
            ...
            <div className="p-4 rounded-2xl bg-indigo-50 border border-indigo-100">
              ...
              <p className="text-[10px] text-indigo-400 font-medium leading-relaxed">
                Use a high-resolution wide-angle shot of the campus. Ideal size: 1920x1080px.
              </p>
            </div>
          </div>
